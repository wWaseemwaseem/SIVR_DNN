...
%%
for i =1:n  
     k1_1 =Lambda-(beta*S(i)*I(i)/(1+alpha*I(i)))-d*S(i)+p*R(i);
     k2_1 =(beta*S(i)*I(i)/(1+alpha*I(i)))-(gama*mu*I(i)/(1+b*mu*I(i)))-d*I(i)-delta*I(i)-m*I(i);
     k3_1 = (gama*mu*I(i)/(1+b*mu*I(i)))-d*R(i)-p*R(i)+m*I(i);
     
     k1_2 =Lambda-(beta*(S(i)+P2*k1_1)*(I(i)+P2*k2_1)/(1+alpha*(I(i)+P2*k2_1)))-d*(S(i)+P2*k1_1)+p*(R(i)+P2*k3_1);
     ...
     k1_3 =Lambda-(beta*(S(i)+P2*k1_2)*(I(i)+P2*k2_2)/(1+alpha*(I(i)+P2*k2_2)))-d*(S(i)+P2*k1_2)+p*(R(i)+P2*k3_2);
     ...
     k1_4 =Lambda-(beta*(S(i)+P2*k1_3)*(I(i)+P2*k2_3)/(1+alpha*(I(i)+P2*k2_3)))-d*(S(i)+P2*k1_3)+p*(R(i)+P2*k3_3);
    ...
    for i =1:n  
     k1_1 =Lambda-(beta*S1(i)*I1(i)/(1+alpha*I1(i)))-d*S1(i)+p*R1(i);
     k2_1 =(beta*S1(i)*I1(i)/(1+alpha*I1(i)))-(gama*mu*I1(i)/(1+b*mu*I1(i)))-d*I1(i)-delta*I1(i)-m*I1(i);
     k3_1 = (gama*mu*I1(i)/(1+b*mu*I1(i)))-d*R1(i)-p*R1(i)+m*I1(i);
     
     k1_2 =Lambda-(beta*(S1(i)+P2*k1_1)*(I1(i)+P2*k2_1)/(1+alpha*(I1(i)+P2*k2_1)))-d*(S1(i)+P2*k1_1)+p*(R1(i)+P2*k3_1);
     ...
     k1_3 =Lambda-(beta*(S1(i)+P2*k1_2)*(I1(i)+P2*k2_2)/(1+alpha*(I1(i)+P2*k2_2)))-d*(S1(i)+P2*k1_2)+p*(R1(i)+P2*k3_2);
     ...
     k1_4 =Lambda-(beta*(S1(i)+P2*k1_3)*(I1(i)+P2*k2_3)/(1+alpha*(I1(i)+P2*k2_3)))-d*(S1(i)+P2*k1_3)+p*(R1(i)+P2*k3_3);
    ...
    for i =1:n  
     k1_1 =Lambda-(beta*S2(i)*I2(i)/(1+alpha*I2(i)))-d*S2(i)+p*R2(i);
     k2_1 =(beta*S2(i)*I2(i)/(1+alpha*I2(i)))-(gama*mu*I2(i)/(1+b*mu*I2(i)))-d*I2(i)-delta*I2(i)-m*I2(i);
     k3_1 = (gama*mu*I2(i)/(1+b*mu*I2(i)))-d*R2(i)-p*R2(i)+m*I2(i);
     
     k1_2 =Lambda-(beta*(S2(i)+P2*k1_1)*(I2(i)+P2*k2_1)/(1+alpha*(I2(i)+P2*k2_1)))-d*(S2(i)+P2*k1_1)+p*(R2(i)+P2*k3_1);
     ...
     k1_3 =Lambda-(beta*(S2(i)+P2*k1_2)*(I2(i)+P2*k2_2)/(1+alpha*(I2(i)+P2*k2_2)))-d*(S2(i)+P2*k1_2)+p*(R2(i)+P2*k3_2);
     ...
     k1_4 =Lambda-(beta*(S2(i)+P2*k1_3)*(I2(i)+P2*k2_3)/(1+alpha*(I2(i)+P2*k2_3)))-d*(S2(i)+P2*k1_3)+p*(R2(i)+P2*k3_3);
    ...
    R2(i+1) = R2(i)+(h/6)*(k3_1+2*k3_2+2*k3_3+k3_4);
     ...
     for i =1:n  
     k1_1 =Lambda-(beta*S3(i)*I3(i)/(1+alpha*I3(i)))-d*S3(i)+p*R3(i);
     k2_1 =(beta*S3(i)*I3(i)/(1+alpha*I3(i)))-(gama*mu*I3(i)/(1+b*mu*I3(i)))-d*I3(i)-delta*I3(i)-m*I3(i);
     k3_1 = (gama*mu*I3(i)/(1+b*mu*I3(i)))-d*R3(i)-p*R3(i)+m*I3(i);
     
     k1_2 =Lambda-(beta*(S3(i)+P2*k1_1)*(I3(i)+P2*k2_1)/(1+alpha*(I3(i)+P2*k2_1)))-d*(S3(i)+P2*k1_1)+p*(R3(i)+P2*k3_1);
     ...
     k1_3 =Lambda-(beta*(S3(i)+P2*k1_2)*(I3(i)+P2*k2_2)/(1+alpha*(I3(i)+P2*k2_2)))-d*(S3(i)+P2*k1_2)+p*(R3(i)+P2*k3_2);
     ...
     k1_4 =Lambda-(beta*(S3(i)+P2*k1_3)*(I3(i)+P2*k2_3)/(1+alpha*(I3(i)+P2*k2_3)))-d*(S3(i)+P2*k1_3)+p*(R3(i)+P2*k3_3);
 ...
 for i =1:n  
     ...
     k1_1 =Lambda-(beta*S4(i)*I4(i)/(1+alpha*I4(i)))-d*S4(i)+p*R4(i);
     k2_1 =(beta*S4(i)*I4(i)/(1+alpha*I4(i)))-(gama*mu*I4(i)/(1+b*mu*I4(i)))-d*I4(i)-delta*I4(i)-m*I4(i);
     k3_1 = (gama*mu*I4(i)/(1+b*mu*I4(i)))-d*R4(i)-p*R4(i)+m*I4(i);
     
     k1_2 =Lambda-(beta*(S4(i)+P2*k1_1)*(I4(i)+P2*k2_1)/(1+alpha*(I4(i)+P2*k2_1)))-d*(S4(i)+P2*k1_1)+p*(R4(i)+P2*k3_1);
     ...
     k1_3 =Lambda-(beta*(S4(i)+P2*k1_2)*(I4(i)+P2*k2_2)/(1+alpha*(I4(i)+P2*k2_2)))-d*(S4(i)+P2*k1_2)+p*(R4(i)+P2*k3_2);
     ...
     k1_4 =Lambda-(beta*(S4(i)+P2*k1_3)*(I4(i)+P2*k2_3)/(1+alpha*(I4(i)+P2*k2_3)))-d*(S4(i)+P2*k1_3)+p*(R4(i)+P2*k3_3);
